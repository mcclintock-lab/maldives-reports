      ...
      <ResultsCard title="Fishing Value" functionName="ousValueOverlap">
        {(data: ReportResult) => {
          ...
          return (
            <>
              <p>
                This report summarizes plan overlap with commercial tuna fishing
                as reported in the Ocean Use Survey. The higher the percentage,
              ...
              <Collapse title="Learn more">
                <p>
                  ℹ️ Fishing Value is used as a proxy for measuring the
