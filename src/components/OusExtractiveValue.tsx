...
import ousTotals from "../../data/precalc/ousExtractiveValueOverlapTotals.json";
const precalcTotals = ousTotals as ReportResultBase;

const METRIC = config.metricGroups.ousExtractiveValueOverlap;

const OusExtractiveValue = () => {
  const [{ isCollection }] = useSketchProperties();
  return (
    <>
      <ResultsCard
        title="Extractive Ocean Use"
        functionName="ousExtractiveValueOverlap"
      >
        {(data: ReportResult) => {
          ...
          return (
            <>
              <p>
                This report summarizes the percentage of activities for offshore
                extractive sectors that overlaps with this offshore plan, as
...
export default OusExtractiveValue;
