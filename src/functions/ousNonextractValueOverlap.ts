...
export async function ousNonextractValueOverlap(
...
export default new GeoprocessingHandler(ousNonextractValueOverlap, {
  title: "ousNonextractValueOverlap",
  description: "ocean use metrics - nonextractive",
  timeout: 180, // seconds
  executionMode: "async",
